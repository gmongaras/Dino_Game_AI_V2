...
function createBrain() {
	...
	//brain = new NeuralNetwork(4, [16, 16, 16, 16, 3], 10);
	brain = new NeuralNetwork(10, 3);
...
function think(dino) {
	...
	if (dino.crash == false) {
		...
		*/
		...
		preds = dino.brain.forward([input1,input2,input3,input4,input5,input6,input7,input8,input9,input10]);
